...
public class LoginTests1 {
    ...
    public void positiveTest() {
        ...
        Assert.assertNotEquals(driver.getCurrentUrl(), LoginPage1.URL, "You are still on login page.");
    }
    ...
    public void negativeTestWrongPassword() {
        ...
        Assert.assertEquals(driver.getCurrentUrl(), LoginPage1.URL, "You are NOT on login page.");
